...
# -*- coding: utf-8 -*-
#
# django-google-address documentation build configuration file, created by
...
project = 'django-google-address'
copyright = '2017, Leonardo Arroyo'
...
htmlhelp_basename = 'django-google-addressdoc'
